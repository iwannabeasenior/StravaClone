...
// if (accessToken != null && refreshToken != null && expiredAt != null && DateTime.fromMicrosecondsSinceEpoch(expiredAt as int).isBefore(DateTime.now())) {
//   TokenResponse? result = await appAuth.token(TokenRequest('115822', 'stravaflutter://redirect',
//     scopes: ['activity:read_all', 'activity:write'],
//     discoveryUrl: 'https://www.strava.com/.well-known/openid-configuration',
//     refreshToken: refreshToken as String?,
//   ));
//   if (result == null) {
//
//   }
//   sharedPreferences.setString('accessTokenStrava', result!.accessToken!);
//   sharedPreferences.setString('refreshTokenStrava', result.refreshToken!);
//   sharedPreferences.setInt('expiredAt', result.accessTokenExpirationDateTime!.microsecondsSinceEpoch);
// } else {
//   AuthorizationTokenResponse? result = await appAuth.authorizeAndExchangeCode(
//       AuthorizationTokenRequest(
//           '115822', 'stravaflutter://redirect',
//           discoveryUrl: 'https://www.strava.com/.well-known/openid-configuration',
//           scopes: ['activity:read_all', 'activity:write']
//       )
//   );
